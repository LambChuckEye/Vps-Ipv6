...
| **VPS**      | **Vultr - 东京**                               | **Hostus - 洛杉矶**          | **RackNerd - 洛杉矶**                |
| ------------ | ---------------------------------------------- | ---------------------------- | ------------------------------------ |
| **价格**     | $5 / m                                         | $16 / y                      | $10.88 / y                           |
| **带宽**     | 1Gbps                                          | 1Gbps                        | 1Gbps                                |
| **流量**     | 1TB                                            | 2TB                          | 1TB                                  |
| **IP**       | 1v4+1v6                                        | 1v4+1v6                      | 1v4+100v6（填工单申请）              |
| **内存**     | 1024MB                                         | 768MB                        | 768MB                                |
| **硬盘**     | 25G                                            | 20G                          | 12G                                  |
| **备注**     | 时间计费，随时启停。<br />有日本节点，低延迟。 | 同学买的，<br />一天后发货。 | 当转发用最划算，<br />工单回复很快。 |
| **Download** | 55.5 Mbps                                      | 3.5 Mbps                     | 30.8 Mbps                            |
| **Upload**   | 88.6 Mbps                                      | 73.0 Mbps                    | 67.6 Mbps                            |
| **Ping**     | 88.2 ms                                        | 178 ms                       | 176 ms                               |
| **Jitter**   | 3.87 ms                                        | 10.2 ms                      | 2.94 ms                              |

> 测速数据来自 http://speed.cloudflare.com，测试环境均为宿舍有线连接。
>
> vultr 和 RackNerd 为 v2ray + bbr 部署，终端使用 clash。
>
> hostus 为 ssr + bbr 部署，终端使用 shadowsocksR。
> 
